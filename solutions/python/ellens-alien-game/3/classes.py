...
class Alien:
    ...
    @classmethod
    def increment_aliens_counter(cls):
        """
    ...
    def __init__(self, x_coordinate, y_coordinate):
        ...
        self.health = 3
        self.__class__.increment_aliens_counter()
    ...
    def is_alive(self):
        """
        Checks if instance of an Alien() has health > 0, is alive.
        """
...
def new_aliens_collection(list_of_positions: list) -> list:
    ...
    """
    return [Alien(coord_x, coord_y) for coord_x, coord_y in list_of_positions]
